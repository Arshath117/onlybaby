...
export const ToyStoreProvider = ({ children }) => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(`https://onlybaby.onrender.com/api/shop`);
    ...
    const fetchMembership = async () => {
      try {
        ...
        const response = await axios.post(
          "https://onlybaby.onrender.com/api/membership/fetch",
          { userId: user?._id }, 
          {
    ...
    const fetchOrderHistory = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://onlybaby.onrender.com/api/orders/getOrderHistory?user=${user._id}`
        );
